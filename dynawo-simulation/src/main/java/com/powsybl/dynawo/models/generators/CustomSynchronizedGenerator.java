 ...
 */
public class CustomSynchronizedGenerator extends SynchronizedGenerator {

    private final CustomGeneratorComponent customComponent;

    protected CustomSynchronizedGenerator(Generator generator, String parameterSetId, ModelConfig modelConfig) {
