...
public class HighVoltageRideThroughAutomationSystem extends AbstractPureDynamicBlackBoxModel {

    protected final Generator generator;
    private boolean isConnected = true;

    protected HighVoltageRideThroughAutomationSystem(String dynamicModelId, String parameterSetId, Generator generator, ModelConfig modelConfig) {
