 ...
 */
public class CustomSynchronizedGeneratorControllable extends SynchronizedGeneratorControllable {

    private final CustomGeneratorComponent customComponent;

    protected CustomSynchronizedGeneratorControllable(Generator generator, String parameterSetId, ModelConfig modelConfig) {
