 ...
 */
public class Ieee14CurrentLimitAutomatonLocalCommandExecutor extends AbstractDynawoLocalCommandExecutor {

    public Ieee14CurrentLimitAutomatonLocalCommandExecutor(FileSystem fileSystem, Network network, DynawoParameters dynawoParameters) {
