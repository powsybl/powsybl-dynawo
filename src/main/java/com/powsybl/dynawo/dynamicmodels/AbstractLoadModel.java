...
public abstract class AbstractLoadModel extends AbstractBlackBoxModel {
    ...
    protected abstract void writeReference(XMLStreamWriter writer, DynawoXmlContext context) throws XMLStreamException;

    protected abstract void writeConnector(XMLStreamWriter writer, DynawoXmlContext context) throws XMLStreamException;
}
