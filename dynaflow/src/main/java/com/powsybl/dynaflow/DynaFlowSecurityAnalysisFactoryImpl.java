...
public class DynaFlowSecurityAnalysisFactoryImpl implements SecurityAnalysisFactory {
    ...
    public SecurityAnalysis create(Network network, LimitViolationDetector detector, LimitViolationFilter filter,
        ...
        return new DynaFlowSecurityAnalysisImpl(network, detector, filter, computationManager);
    }
}
