 ...
 */
public final class DefaultBusModel implements ConnectionPoint {

    private static DefaultBusModel INSTANCE;

    private DefaultBusModel() {
    }

    public static DefaultBusModel getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new DefaultBusModel();
        }
        return INSTANCE;
    }
