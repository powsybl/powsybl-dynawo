...
public enum DefaultModelConfiguration {
    ...
    ACTION_CONNECTION_POINT(IdentifiableType.BUS,
            ...
            new DefaultModelFactory<ActionConnectionPoint>(DefaultActionConnectionPoint::new)),
    ...
    GENERATOR(IdentifiableType.GENERATOR,
            ...
            new DefaultModelFactory<GeneratorModel>(DefaultGenerator::new)),
    HVDC(IdentifiableType.HVDC_LINE,
            HvdcModel.class,
            new DefaultModelFactory<HvdcModel>(DefaultHvdc::new)),
    LINE(IdentifiableType.LINE,
            LineModel.class,
            new DefaultModelFactory<LineModel>(DefaultLine::new)),
    LOAD(IdentifiableType.LOAD,
            LoadModel.class,
            new DefaultModelFactory<LoadModel>(DefaultLoad::new)),
    SHUNT_COMPENSATOR(IdentifiableType.SHUNT_COMPENSATOR,
            ShuntModel.class,
            new DefaultModelFactory<ShuntModel>(DefaultShunt::new)),
    STATIC_VAR_COMPENSATOR(IdentifiableType.STATIC_VAR_COMPENSATOR,
            StaticVarCompensatorModel.class,
            new DefaultModelFactory<StaticVarCompensatorModel>(DefaultStaticVarCompensator::new)),
    TWO_WINDINGS_TRANSFORMER(IdentifiableType.TWO_WINDINGS_TRANSFORMER,
            TransformerModel.class,
            new DefaultModelFactory<TransformerModel>(DefaultTransformer::new));
