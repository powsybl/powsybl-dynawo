 ...
 */
class DisconnectHvdcVscEventXmlTest extends AbstractDynamicModelXmlTest {
    ...
    protected void addDynamicModels() {
        dynamicModels.add(new HvdcVsc("BBM_HVDC", network.getHvdcLine("L"), "hvdc", "HvdcVsc"));
        eventModels.add(new EventHvdcDisconnection(network.getHvdcLine("L"), 1, false, true));
    }
    ...
    void writeDisconnectModel() throws SAXException, IOException, XMLStreamException {
        ...
        validate("dyd.xsd", "disconnect_hvdc_vsc_dyd.xml", tmpDir.resolve(DynaWaltzConstants.DYD_FILENAME));
