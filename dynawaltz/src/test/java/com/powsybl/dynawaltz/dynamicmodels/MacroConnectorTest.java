...
public class MacroConnectorTest {
    ...
    public void compareTwoMacroConnectorsSameLib1DifferentLib2() {
        ...
        MacroConnector connector1 = new MacroConnector(dumdum1, dumdum2, List.of(Pair.of("pair1", "pair2")));
        MacroConnector connector2 = new MacroConnector(dumdum1, mock(BlackBoxModel.class), List.of(Pair.of("pair1", "pair2")));
    ...
    public void compareTwoMacroConnectorsSameLib2DifferentLib1() {
        ...
        MacroConnector connector1 = new MacroConnector(dumdum1, dumdum2, List.of(Pair.of("pair1", "pair2")));
        MacroConnector connector2 = new MacroConnector(mock(BlackBoxModel.class), dumdum2, List.of(Pair.of("pair1", "pair2")));
        assertNotEquals(connector1, connector2);
    }
