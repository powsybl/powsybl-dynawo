...
/**
 * Conformity test: loads the ENTSO-E MicroGrid Type1 Netherlands MAS dynamic profile
 * and verifies that all model instances are correctly parsed by the dynawo-cgmes-dy module.
 * @author Gautier Bureau {@literal <gautier.bureau at rte-france.com>
 */
class MicroGridType1NlMasConformityTest {

    private static final String RESOURCE =
        "/conformity/MicroGrid-Type1/MicroGrid-Type1-NL-MAS/20210420T1730Z_1D_NL_DY_001.xml";
    ...
    @BeforeAll
    static void parse() {
        InputStream stream = MicroGridType1NlMasConformityTest.class.getResourceAsStream(RESOURCE);
