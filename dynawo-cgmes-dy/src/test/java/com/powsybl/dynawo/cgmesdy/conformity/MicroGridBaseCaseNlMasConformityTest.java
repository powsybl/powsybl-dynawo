...
/**
 * Conformity test: loads the ENTSO-E MicroGrid Base Case Netherlands MAS dynamic profile
 * and verifies that all model instances are correctly parsed by the dynawo-cgmes-dy module.
 * @author Gautier Bureau {@literal <gautier.bureau at rte-france.com>
 */
class MicroGridBaseCaseNlMasConformityTest {

    private static final String RESOURCE =
        "/conformity/MicroGid-BaseCase/MicroGrid-NL-MAS/20210420T1730Z_1D_NL_DY_001.xml";
    ...
    @BeforeAll
    static void parse() {
        InputStream stream = MicroGridBaseCaseNlMasConformityTest.class.getResourceAsStream(RESOURCE);
