...
public class Outputs {
    ...
    public Outputs(String directory, String curve) {
        this(directory, true, true, null, "TXT", false, false, false, curve, "CSV");
    }

    public Outputs(String directory, boolean dumpLocalInitValues, boolean dumpGlobalInitValues,
    ...
    public Outputs addAppenders(List<LogAppender> appender) {
