...
public class Parameter {
    ...
    public Parameter(String name, String type, String origData, String origName) {
        this(name, type, origData, origName, null);
    }

    public Parameter(String name, String type, String origData, String origName, String componentId) {
        this.reference = true;
        this.name = Objects.requireNonNull(name);
        this.type = Objects.requireNonNull(type);
