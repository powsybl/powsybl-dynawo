...
public class Modeler {
    ...
    public Modeler(String compile, String iidm, String parameters, String parameterId, String dyd) {
        this(compile, null, true, null, true, iidm, parameters, parameterId, dyd, null);
    }

    public Modeler(String compile, String preCompiledModelsDir, boolean useStandardModelsPreCompiledModels,
