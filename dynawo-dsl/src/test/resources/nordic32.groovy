...
dynamicModel {
    blackBoxModelId 'OMEGA_REF'
    blackBoxModelLib 'DYNModelOmegaRef'
    parametersFile 'dynawoModel.par'
    parametersId 2
}
dynamicModel {
    blackBoxModelId '_N1011____EC'
    blackBoxModelLib 'LoadAlphaBeta'
    parametersFile 'dynawoModel.par'
    parametersId 3
    staticId '_N1011____EC'
}
dynamicModel {
    blackBoxModelId '_G10______SM'
    blackBoxModelLib 'GeneratorSynchronousFourWindingsProportionalRegulations'
    parametersFile 'dynawoModel.par'
    parametersId 4
    staticId '_G10______SM'
}
dynamicModel {
    blackBoxModelId 'DISCONNECT_LINE'
    blackBoxModelLib 'EventQuadripoleDisconnection'
    parametersFile 'dynawoModel.par'
    parametersId 5
}
dynamicModel {
    connectionId1 '_N1011____EC'
    connectionVar1 'load_terminal'
    connectionId2 'NETWORK'
    connectionVar2 '_N1011____TN_ACPIN'
}
dynamicModel {
    connectionId1 'OMEGA_REF'
    connectionVar1 'omega_grp_0'
    connectionId2 '_G10______SM'
    connectionVar2 'generator_omegaPu'
}
dynamicModel {
    connectionId1 'OMEGA_REF'
    connectionVar1 'omegaRef_grp_0'
    connectionId2 '_G10______SM'
    connectionVar2 'generator_omegaRefPu'
}
dynamicModel {
    connectionId1 'OMEGA_REF'
    connectionVar1 'numcc_node_0'
    connectionId2 'NETWORK'
    connectionVar2 '@_G10______SM@@NODE@_numcc'
}
dynamicModel {
    connectionId1 'OMEGA_REF'
    connectionVar1 'running_grp_0'
    connectionId2 '_G10______SM'
    connectionVar2 'generator_running'
}
dynamicModel {
    connectionId1 '_G10______SM'
    connectionVar1 'generator_terminal'
    connectionId2 'NETWORK'
    connectionVar2 '@_G10______SM@@NODE@_ACPIN'
}
dynamicModel {
    connectionId1 '_G10______SM'
    connectionVar1 'generator_switchOffSignal1'
    connectionId2 'NETWORK'
    connectionVar2 '@_G10______SM@@NODE@_switchOff'
}
dynamicModel {
    connectionId1 'DISCONNECT_LINE'
    connectionVar1 'event_state1_value'
    connectionId2 'NETWORK'
    connectionVar2 '_N1011___-N1013___-1_AC_state_value'
}
curve {
    model 'NETWORK'
