...
class EventModelsSupplierTest extends AbstractModelSupplierTest {
    ...
    private static Stream<Arguments> provideEventModelData() {
        return Stream.of(
                ...
                Arguments.of("/eventModels/referenceVoltageVariation.groovy", EventReferenceVoltageVariation.class, EurostagTutorialExample1Factory.createWithLFResults(), "LOAD", "ReferenceVoltageVariation_LOAD", null, 2)
        );
    }
