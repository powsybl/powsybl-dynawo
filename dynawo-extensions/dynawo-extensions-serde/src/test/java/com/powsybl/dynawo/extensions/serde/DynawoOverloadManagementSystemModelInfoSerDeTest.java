 ...
 */
class DynawoOverloadManagementSystemModelInfoSerDeTest extends AbstractSerDeTest {
    ...
    void testXmlSerializer() throws IOException {
        ...
        adder.withDynamicModelId("OMS")
                ...
                .withIMeasurementSide(TwoSides.TWO)
                .add();
        ...
        roundTripXmlTest(network,
                ...
                "/dynawoOverloadManagementSystemModelInfo.xml");
    }
}
