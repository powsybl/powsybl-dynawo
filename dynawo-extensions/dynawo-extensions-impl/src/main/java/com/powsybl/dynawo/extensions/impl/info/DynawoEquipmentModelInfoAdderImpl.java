...
public class DynawoEquipmentModelInfoAdderImpl<I extends Identifiable<I>> extends AbstractDynawoModelInfoAdder<I, DynawoEquipmentModelInfo<I>, DynawoEquipmentModelInfoAdderImpl<I>>
    ...
    public DynawoEquipmentModelInfoAdderImpl(I identifiable) {
        super(identifiable);
    }

    @Override
    protected DynawoEquipmentModelInfo<I> createExtension(I extendable) {
        return new DynawoEquipmentModelInfoImpl<>(extendable, modelName, parameterSetId);
    }
