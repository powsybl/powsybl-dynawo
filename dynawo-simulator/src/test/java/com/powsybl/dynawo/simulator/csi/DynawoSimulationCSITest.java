...
import com.powsybl.dynawo.simulator.DynawoSimulationTester;
 ...
 */
public class DynawoSimulationCSITest {
    ...
    public void testCSI() throws Exception {
        try (FileSystem fs = Jimfs.newFileSystem(Configuration.unix())) {
            ...
            DynawoInputProvider inputProvider = configureProvider(network);
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DynawoSimulationCSITest.class);
}
